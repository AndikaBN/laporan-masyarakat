...
<div style="padding: 30px; max-width: 650px; margin: 0 auto;">
    <div style="margin-bottom: 30px;">
        <h1 style="color: #333; margin: 0; font-size: 28px; font-weight: 700;">➕ Buat Agensi Baru</h1>
        <p style="color: #666; margin: 8px 0 0 0;">Daftarkan agensi baru ke dalam sistem</p>
    </div>
    ...
    <form action="{{ route('agencies.store') }}" method="POST" style="background: white; padding: 28px; border-radius: 10px; box-shadow: 0 2px 12px rgba(0,0,0,0.08);">
        @csrf
        ...
        <div style="margin-bottom: 24px;">
            ...
            <input type="email" id="contact" name="contact" value="{{ old('contact') }}" required
                   style="width: 100%; padding: 12px 14px; border: 2px solid #e0e0e0; border-radius: 6px; font-size: 14px; box-sizing: border-box; transition: border-color 0.3s, box-shadow 0.3s;"
                   placeholder="Contoh: pendidikan@pemda.local"
                   onmouseover="this.style.borderColor='#bbb'"
                   onmouseout="this.style.borderColor='#e0e0e0'"
                   onfocus="this.style.borderColor='#007bff'; this.style.boxShadow='0 0 0 3px rgba(0,123,255,0.1)'"
                   onblur="this.style.borderColor='#e0e0e0'; this.style.boxShadow='none'">
        ...
        <div style="margin-bottom: 24px;">
            ...
            <textarea id="description" name="description" rows="4"
                      ...
                      placeholder="Jelaskan peran dan tanggung jawab agensi ini..."
                      onmouseover="this.style.borderColor='#bbb'"
                      onmouseout="this.style.borderColor='#e0e0e0'"
                      onfocus="this.style.borderColor='#007bff'; this.style.boxShadow='0 0 0 3px rgba(0,123,255,0.1)'"
        ...
        <div style="background: linear-gradient(135deg, #e7f3ff 0%, #d5e9f7 100%); border-left: 4px solid #2196F3; padding: 16px; border-radius: 8px; margin-bottom: 28px; box-shadow: 0 2px 8px rgba(33,150,243,0.1);">
            ...
            <ul style="margin: 0; padding-left: 20px; color: #1565c0; font-size: 13px; line-height: 1.6;">
                <li>Agensi ini akan dapat memiliki kategori dan pengguna tersendiri</li>
                <li>Pengguna admin dari agensi hanya melihat data milik agensi mereka</li>
                <li>Email kontak digunakan untuk notifikasi sistem kepada agensi</li>
                <li>Data dapat diubah kapan saja melalui halaman edit agensi</li>
            </ul>
        </div>
